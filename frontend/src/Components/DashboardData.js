...
const DashboardData = () => {
  ...
  let sublabel = ["Telugu", "Hindi", "English", "Maths", "Science"];
  console.log(sublabel[maxIndex] + "" + maxData);
  console.log(sublabel[minIndex] + "" + minData);
  barvalues[j] = 0;
  barvalues[j + 1] = 100;
  const barData = {
    labels: ["Telugu", "Hindi", "English", "Maths", "Science"],
    datasets: [
      {
        barPercentage: 0.1,
              ...
              >
                ...
                <div className="DBHistoryBody">
                  ...
                  <div className="DBHistoryText">
                    <span>{"Telugu: " + test[0].toFixed(2) + "%"}</span>
                    <span>{"Hindi: " + test[1].toFixed(2) + "%"}</span>
                    <span>{"English: " + test[2].toFixed(2) + "%"}</span>
                    <span>{"Maths: " + test[3].toFixed(2) + "%"}</span>
                    <span>{"Science: " + test[4].toFixed(2) + "%"}</span>
                  </div>
                </div>
              </div>
            );
